...
public class ComposeMediaViewController{
	...
	public boolean addMediaAttachment(Uri uri, String description){
		if(getMediaAttachmentsCount()==getMaxAttachments()){
			showMediaAttachmentError(fragment.getResources().getQuantityString(R.plurals.cant_add_more_than_x_attachments, getMaxAttachments(), getMaxAttachments()));
			return false;
		}
...
//			att.retryButton.setContentDescription(fragment.getString(R.string.cancel));
	...
	public boolean canAddMoreAttachments(){
		return attachments.size()<getMaxAttachments();
	}
	...
	public int getMaxAttachments(){
		return org.joinmastodon.android.GlobalUserPreferences.maxImagesLimit;
	}
